...
public class DepositAction3 implements StripsAction{
	public DepositAction3(){
	}
	...
	public String toString(){
		return "Deposit3, precondition: for 3 peasants: AtLocation(PeasantI, Townhall) ^ HasCargo(PeasantI) , postcondition: townhall + 100 of either wood or gold ^ !HasCargo(PeasantI)";
	}
