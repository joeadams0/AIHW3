...
public class HarvestGoldAction2 implements StripsAction{
	public HarvestGoldAction2(){
	}
	...
	public String toString(){
		return "Harvest Gold2, precondition: for 2 peasants: AtLocation(PeasantI, MineI) ^ HasWood(MineI) ^ !HasCargo(PeasantI) , postcondition: mineI - 100 gold ^ HasCargo(PeasantI)";
	}
