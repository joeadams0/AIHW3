...
public class MoveAction3 implements StripsAction{
	private StripsLocation Location;
	public MoveAction3(StripsLocation Location){
	...
	public String toString(){
		return "Move to: "+Location.toString()+", precondition: for 3 Peasants: !AtLocation(PeasantI, Destination) , postcondition: AtLocation(PeasantI, Destination)";
	}
