...
public class HarvestWoodAction2 implements StripsAction{
	public HarvestWoodAction2(){
	}
	...
	public String toString(){
		return "Harvest Wood2, precondition: for 2 peasants: AtLocation(PeasantI, ForestI) ^ HasWood(ForestI) ^ !HasCargo(PeasantI) , postcondition: forestI - 100 wood ^ HasCargo(PeasantI)";
	}
